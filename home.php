  <section id="hero" class="d-flex align-items-center mr-30">
    <div class="container">
      <h1>Welcome to <?php echo isset($meta['blog_name']) ? $meta['blog_name'] : '' ?></h1>
      <p>Dive into the Stories That Matter</p>
    </div>
  </section>
  <section class="d-flex align-items-center">
	<div class="container-fluid">
	    ...
	    ?>
	    <div class="card col-12 list-items border-0"  data-id="<?php echo $row['id'] ?>">
	    	<div class="card-body">
	    		<div class="row">
	    		<div class="col-md-4">
